...
!function ($) {
    ...
    SmartBanner.prototype = {
      ...
      , show: function(callback) {
            $('#smartbanner').animate({top:0},this.options.speedIn).addClass('shown')
            $('html').animate({marginTop:0},this.options.speedIn,'swing',callback)
        }
        
      , hide: function(callback) {
            $('#smartbanner').animate({top:-1*this.bannerHeight*this.scale},this.options.speedOut).removeClass('shown')
