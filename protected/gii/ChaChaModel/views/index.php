...
");
?>
<h1>ChaCha Model Generator</h1>

<p>This generator generates a model class for the specified database table.</p>
<div style="color: red;font-weight: bold; font-size: 13px; background: none repeat scroll 0 0 #FFEEEE; border: 2px solid #CC0000; margin: 0 0 20px;  padding: 7px 7px 12px; ">
	Lưu ý: Khi build lại model cho các đối tượng: song,video,album,playlist, ringtone. Cần phải edit class Base[] lại extends từ lớp ChachaContentModel thay cho lớp ChachaActiveRecord mặc định
</div>
