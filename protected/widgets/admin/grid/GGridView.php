...
Yii::import('application.widgets.admin.grid.GCBaseListView');
Yii::import('application.widgets.admin.grid.CDataColumn');
Yii::import('application.widgets.admin.grid.CLinkColumn');
Yii::import('application.widgets.admin.grid.CButtonColumn');
Yii::import('application.widgets.admin.grid.CCheckBoxColumn');
 ...
 * @since 1.1
 */
class GGridView extends GCBaseListView {
    ...
    public function renderItems() {
        if (count($this->treeData) > 0 || $this->showTableOnEmpty) {
    ...
    public function renderTableHeader() {
        if (!$this->hideHeader) {
            #echo "<pre>";print_r($this->columns);die("dagfsa");
            echo "<thead>\n";
    ...
    public function renderSummary(){
       echo  '<div class="summary">Hiển thị kết quả.</div>';
    }
