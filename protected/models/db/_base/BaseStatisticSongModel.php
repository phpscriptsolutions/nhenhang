...
class BaseStatisticSongModel extends MainActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('song_name, artist_name', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('date, song_id, song_name, artist_id, artist_name, genre_id, cp_id, played_count, played_count_web, played_count_wap, played_count_api_ios, played_count_api_android, played_count_api_winphone, downloaded_count, downloaded_count_web, downloaded_count_wap, downloaded_count_api_ios, downloaded_count_api_android, downloaded_count_api_winphone, total_sub_listen, total_sub_download, total_nosub_listen, total_nosub_download', 'safe', 'on'=>'search'),
		);
	}
