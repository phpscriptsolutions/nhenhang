...
<div class="content-body">
	...
	<?php $form=$this->beginWidget('CActiveForm', array(
		...
		<div class="row">
			...
			<?php echo CHtml::textField("song_name",isset($options["song_name"])?$options["song_name"]:"",array('style' => 'width:200px')); ?>
		</div>
		...
		<div class="row">
			...
			<?php 
		       $this->widget('ext.daterangepicker.input',array(
		            'name'=>'date',
		       		//'value'=>isset($_GET['report']['date'])?urldecode($_GET['report']['date']):($fromDate. ' - ' .$toDate),
		        ));
		     ?>
		     </div>
		</div>
