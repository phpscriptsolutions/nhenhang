...
$('#radio_playlist form').submit(function(){
	$.fn.yiiGridView.update('admin-radio-collection-playlist', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="wide form search-form" id="radio_playlist" style="margin-bottom:0;padding:5px 10px ">
...
$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'admin-radio-collection-playlist',
