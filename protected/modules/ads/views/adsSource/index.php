...
$this->menu=array(	
	array('label'=> Yii::t("admin","Thêm mới"), 'url'=>array('create'), 'visible'=>UserAccess::checkAccess('ads-AdsSourceCreate')),
		array('label'=> Yii::t("admin","Tạo link quảng cáo"), 'url'=>array('/ads/adsMarketing/create'), 'visible'=>UserAccess::checkAccess('ads-AdsMarketingCreate')),
);
$this->pageLabel = Yii::t("admin","Danh sách AdsSource");
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('admin-ads-source-model-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
$form=$this->beginWidget('CActiveForm', array(
	'action'=>Yii::app()->createUrl('ads/adsSource/bulk'),
	'method'=>'post',
...
if(Yii::app()->user->hasFlash('AdsSource')){
    echo '<div class="flash-success">'.Yii::app()->user->getFlash('AdsSource').'</div>';
}


$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'admin-ads-source-model-grid',
	...
	'columns'=>array(
		...
		array(
				'header'=>'Status',
				'type'=>'raw',
				'value'=>'($data->status==1)?"<span class=\"s_label s_1\">Actived</span>":($data->status==0?"<span class=\"s_label s_0\">DeActived</span>":"<span class=\"s_label s_2\">Deleted</span>")'
		),
		'id',
		array(
			'class'=>'CButtonColumn',
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('admin-ads-source-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
