...
<div class="content-body grid-view" style="padding-top: 20px;">
	<table width="100%" class="items">
		<tr>
			...
			<th height="20" style="vertical-align: middle; color: #FFF">Bộ câu hỏi</th>
			<th height="20" style="vertical-align: middle; color: #FFF">Câu hỏi</th>
			<th height="20" style="vertical-align: middle;color: #FFF">Điểm</th>
		</tr>
