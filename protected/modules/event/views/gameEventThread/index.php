...
$this->pageLabel = Yii::t("admin","Danh sách GameEventThread");
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('game-event-thread-model-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
if(Yii::app()->user->hasFlash('GameEventThread')){
    echo '<div class="flash-success">'.Yii::app()->user->getFlash('GameEventThread').'</div>';
}


$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'game-event-thread-model-grid',
	...
	'columns'=>array(
		...
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('game-event-thread-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
