...
$this->pageLabel = Yii::t("admin","Danh sách GameEventQuestion");
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('game-event-question-model-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
if(Yii::app()->user->hasFlash('GameEventQuestion')){
    echo '<div class="flash-success">'.Yii::app()->user->getFlash('GameEventQuestion').'</div>';
}


$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'game-event-question-model-grid',
	...
	'columns'=>array(
		...
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('game-event-question-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
