...
$this->pageLabel = Yii::t("admin","Danh sách GameEventUserLog");
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('game-event-user-log-model-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
if(Yii::app()->user->hasFlash('GameEventUserLog')){
    echo '<div class="flash-success">'.Yii::app()->user->getFlash('GameEventUserLog').'</div>';
}


$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'game-event-user-log-model-grid',
		...
		*/
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('game-event-user-log-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
