...
$this->menu=array(	
	array('label'=> Yii::t("admin","Thêm mới"), 'url'=>array('create'), 'visible'=>UserAccess::checkAccess('shortlink-DefaultIndex')),
);
$this->pageLabel = Yii::t("admin","Danh sách Shortlink");
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('admin-shortlink-model-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
if(Yii::app()->user->hasFlash('Shortlink')){
    echo '<div class="flash-success">'.Yii::app()->user->getFlash('Shortlink').'</div>';
}


$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'admin-shortlink-model-grid',
	...
	'columns'=>array(
		...
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('admin-shortlink-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
