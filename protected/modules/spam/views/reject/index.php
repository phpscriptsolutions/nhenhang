...
//);
$this->pageLabel = Yii::t("admin","Danh sách SpamSmsRejectPhone");
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('spam-sms-reject-phone-model-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="title-box search-box">
    <?php echo CHtml::link(yii::t('admin','Tìm kiếm và thêm mới'),'#',array('class'=>'search-button')); ?></div>
...
if(Yii::app()->user->hasFlash('SpamSmsRejectPhone')){
    echo '<div class="flash-success">'.Yii::app()->user->getFlash('SpamSmsRejectPhone').'</div>';
}


$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'spam-sms-reject-phone-model-grid',
	...
	'columns'=>array(
		...
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('spam-sms-reject-phone-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
