...
$this->pageLabel = Yii::t("admin","Danh sách Metadata");
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('admin-metadata-model-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
if(Yii::app()->user->hasFlash('Metadata')){
    echo '<div class="flash-success">'.Yii::app()->user->getFlash('Metadata').'</div>';
}


$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'admin-metadata-model-grid',
	...
	'columns'=>array(
		...
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('admin-metadata-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
