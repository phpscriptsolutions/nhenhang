...
$this->menu=array(
	...
	array('label'=>Yii::t('admin', 'Sao chép'), 'url'=>array('copy','id'=>$model->id), 'visible'=>UserAccess::checkAccess('MetadataCopy')),
);
$this->pageLabel = Yii::t('admin', "Cập nhật Metadata")."#".$model->id;
