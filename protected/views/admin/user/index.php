...
$this->menu=array(
	array('label'=>'Create', 'url'=>array('create'), 'visible'=>UserAccess::checkAccess('UserCreate')),
);
$this->pageLabel = "List User";
...
?>
<script>
    var idf = 'admin-user-model-grid';
    var modelf = 'AdminUserModel_page';
</script>
<?php
$this->widget('application.widgets.admin.grid.CGridView', array(
	'id'=>'admin-user-model-grid',
		...
		*/
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('admin-user-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
