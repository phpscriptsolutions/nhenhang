...
$this->pageLabel = Yii::t("admin","Danh sách Config");
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('config-model-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
if(Yii::app()->user->hasFlash('Config')){
    echo '<div class="flash-success">'.Yii::app()->user->getFlash('Config').'</div>';
}


$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'config-model-grid',
	...
	'columns'=>array(
		...
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('config-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
