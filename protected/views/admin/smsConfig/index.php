...
$this->pageLabel = Yii::t("admin", "Danh sách cấu hình tin nhắn");
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('sms-config-model-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
if (Yii::app()->user->hasFlash('SmsConfig')) {
    echo '<div class="flash-success">' . Yii::app()->user->getFlash('SmsConfig') . '</div>';
}


$this->widget('zii.widgets.grid.CGridView', array(
    'id' => 'sms-config-model-grid',
    ...
    'columns' => array(
        ...
        array(
            ...
            'header' => CHtml::dropDownList('pageSize', $pageSize, array(10 => 10, 30 => 30, 50 => 50, 100 => 100), array(
                'onchange' => "$.fn.yiiGridView.update('sms-config-model-grid',{ data:{pageSize: $(this).val() }})",
            )),
