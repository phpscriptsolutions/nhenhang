...
$this->menu=array(
	...
	array('label'=>Yii::t('admin','Thông tin'), 'url'=>array('view', 'id'=>$model->id), 'visible'=>UserAccess::checkAccess('VideoPlaylistView')),
);
$this->pageLabel = Yii::t('admin','Cập nhật video playlist: {name}',array('{name}'=>$model->name)); 
