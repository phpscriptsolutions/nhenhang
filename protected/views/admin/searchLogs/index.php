...
$this->pageLabel = Yii::t("admin","Danh sách SearchLogs");
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('search-logs-model-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
if(Yii::app()->user->hasFlash('SearchLogs')){
    echo '<div class="flash-success">'.Yii::app()->user->getFlash('SearchLogs').'</div>';
}


$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'search-logs-model-grid',
		...
		*/
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('search-logs-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
