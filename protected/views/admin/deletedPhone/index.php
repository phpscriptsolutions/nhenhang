...
$this->pageLabel = Yii::t("admin","Danh sách DeletedPhone");
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('deleted-phone-model-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
if(Yii::app()->user->hasFlash('DeletedPhone')){
    echo '<div class="flash-success">'.Yii::app()->user->getFlash('DeletedPhone').'</div>';
}


$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'deleted-phone-model-grid',
	...
	'columns'=>array(
		...
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('deleted-phone-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
