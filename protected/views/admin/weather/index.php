...
$this->pageLabel = Yii::t("admin","Danh sách Weather");
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('admin-weather-model-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
if(Yii::app()->user->hasFlash('Weather')){
    echo '<div class="flash-success">'.Yii::app()->user->getFlash('Weather').'</div>';
}


$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'admin-weather-model-grid',
	...
	'columns'=>array(
		...
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('admin-weather-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
