...
$this->menu=array(
	...
	array('label'=>Yii::t('admin', 'Thông tin'), 'url'=>array('view', 'id'=>$model->id), 'visible'=>UserAccess::checkAccess('TopContentView')),
);
$this->pageLabel = Yii::t('admin', "Cập nhật TopContent")."#".$model->id;
