...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		presetRanges: [
			{text: 'Hôm nay', dateStart: 'today', dateEnd: 'today' },
			{text: '7 ngày trước', dateStart: 'today-7days', dateEnd: 'today' },
			{text: 'Tháng này', dateStart: function(){ return Date.parse('today').moveToFirstDayOfMonth();  }, dateEnd: 'today' },
			{text: 'Năm này', dateStart: function(){ var x= Date.parse('today'); x.setMonth(0); x.setDate(1); return x; }, dateEnd: 'today' },
			//extras:
			{text: 'Tháng trước', dateStart: function(){ return Date.parse('1 month ago').moveToFirstDayOfMonth();  }, dateEnd: function(){ return Date.parse('1 month ago').moveToLastDayOfMonth();  } }
		...
		presets: {
			specificDate: 'Ngày xác định', 
			//allDatesBefore: 'All Dates Before', 
			//allDatesAfter: 'All Dates After', 
			dateRange: 'Trong khoảng'
		},
